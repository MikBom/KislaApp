      ...
      <ScrollView>
        ...
        <View style={styles.kuvaWrapper}>
          ...
          <View style={styles.kuvaItemsWrapper}>
            <Text style={styles.uutisetTitle}>Tähän päivitetään uutisia. Oli tarkoitus tehdä feedi joka antais previewen ulkoiselle nettisivulle. Alapuolelle kuviin oli tarkoitus tehdä preview ikkuna someen, mutta on hiukan hankala toteuttaa. Joten tällä konseptilla etusivu.</Text>
          </View>
        </View>
